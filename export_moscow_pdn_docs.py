...
def write_architecture() -> Path:
    ...
    table2(
        ...
        [
            ...
            (
                ...
                "Игра / сервер — Москва (YOUR_VPS_IP); ИИ-мост — NL",
    ...
    para(
        ...
        "московский сервер YOUR_VPS_IP отдельным каталогом /opt/sro-bot "
...
def write_migrate_checklist() -> Path:
    ...
    bullets(
        doc,
        [
            "Вариант A (быстрее): тот же VPS, что Minecraft — YOUR_VPS_IP, "
